  ...
  return (
    <Container className='thanks-page__container'>
      <div className='thanks-page'>
        ...
        <p className='thanks-page__description'>the order will be send to you</p>
      </div>
      ...
      <div className='thanks-page__order'>
        ...
        <p className='thanks-page__order-description'>you can see your order in profile section</p>
